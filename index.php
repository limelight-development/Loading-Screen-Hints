...
$hints[] = ['General', 'Tom', 'Did you know? If your HUD is glitched out, you can type \'/hud rebuild\' in the chat window to fix it!'];
$hints[] = ['General', 'Tom', 'Did you know? You can disable the tint around your HUD? Try typing \'/hud tint\' in the chat window!'];
...
$hints[] = ['General', 'ForceGhost', 'Teachers and Staff can hand out REPs for good roleplays, which can unlock new items!'];
...
$hints[] = ['General', 'Montyfatcat', 'Struggling to think of a command or just looking for some assistance? Try using /help (message], an online teacher will try to respond to you as soon as they can.'];
...
$hints[] = ['General', 'Faustin', 'Want to make a decision but leave it up to chance? Use /roll (max number].'];
...
$hints[] = ['General', 'Faustin', 'Did you know we also have a TeamSpeak server? You can find a link to this at the top of our forums on limelightgaming.net.'];
$hints[] = ['General', 'Faustin', 'Did you know we have Discord server? You can find a link to this at the top of our forums on limelightgaming.net.'];
...
$hints[] = ['General', 'Nebula', 'Hungry and no chefs available? Press \'E\' on the many vending machines dotted around the map to get a delicious snack.'];
...
$hints[] = ['General', 'Faustin', 'Want to constantly send an /it command to everyone in a certain area? Use the IT Emitter Tool!'];
...
$hints[] = ['General', 'Faustin', '\'Run, Forrest, Run!\' Use some steroids purchasable from a Doctor to keep your stamina up!'];
...
$hints[] = ['General', 'Ben', 'Have an RP in mind but not able to use the specific outfit you had planned for this? Try typing \'/help\' in the chat window, a teacher or staff member might be able to set it for you!'];
$hints[] = ['General', 'Zaidplays', 'Want to purchase something in-game? Go to F1 -> Market.'];
$hints[] = ['General', 'Zaidplays', 'Got weird sounds which might be broken? Run the \'stopsound\' command in cnsole to stop them.'];
...
$hints[] = ['Forums', 'Faustin', 'Think you have what it takes to become a Teacher? Feel free to apply under the \'Teachers\' section of our Forums.'];
...
$hints[] = ['Vehicles', 'ForceGhost', 'Want to listen to some tunes as you\'re driving around? Try typing \'/evoradio on\' to blast some out!'];
...
$hints[] = ['Vehicles', 'Vadar', 'Keep to a set speed limit by typing \'/cruise\' in the chat window or risk a possible arrrest by speeding to get to your destination quicker.'];
...
$hints[] = ['Government', 'ForceGhost', 'AAll of your lighting and siren binds can be changed! Hold Q, click the \'Utilities\' tab in the top right of your screen and click \'Controls\' under the Photon Sub-Menu to change them to your liking!'];
...
$hints[] = ['Government', 'Miss Joley', 'Need to raise the tax as the President to support your lavish lifestyle or to fund your government? Try typing \'/tax (0-20]\' in the chat window to adjust this to your liking.'];
$hints[] = ['Government', 'Miss Joley', 'Has a serious incident occured while you\'re President and need everyone to stay indoors for the time being? Type \'/lockdown\' in the chat window to send out a public alert.'];
...
$hints[] = ['Locations', 'Cole', 'Not sure where you\'re going or where you are? Try typing /map in the chat window to be given a birds-eye view of all available locations.'];
...
$hints[] = ['Locations', 'Cole', 'Feel like some fish for dinner? Head on over to your local chef, purchase a fishing rod from them and then travel to Evocity Lake with your rod to catch some!'];
$hints[] = ['Locations', 'Cole', 'Grown some weed? Head to the alley behind Back Street, Stormzy is sure to have a good deal for you...'];
$hints[] = ['Locations', 'ForceGhost', 'Got some splintered timber or strong wood? Head on over to Industrial to sell them to the lumberjack for a nice profit.'];
$hints[] = ['Locations', 'Vadar', 'Don\'t know where a certain spot is? Use \'/map\' to get an overview of the whole map.'];
...
$hints[] = ['Fire Department', 'Stell90', 'Ran out of foam for your fire extinguisher? Approach your fire engine, look at it and type \'/resupply\' in the chat window. You’ll be back fighting fires in no time!'];


$hints[] = ['Radio', 'Stell90 & Cole', 'Did you know the government has its own voice radio? In order to use the radio, use the key you\'ve binded to \'Suit Zoom\' in the keyboard options.'];
$hints[] = ['Radio', 'Stell90 & Cole', 'Try typing \'/listen (type]\' in the chat window to change what radio channel you’re currently tuned in to.'];
$hints[] = ['Radio', 'Stell90 & Cole', 'Try typing \'/voice (type]\' in the chat window to change which radio channel you\'re transmitting to.'];
$hints[] = ['Radio', 'Stell90 & Cole', 'Try typing \'/frequency (80-120]\' in the chat window to change the frequency of your private radio channel.'];
$hints[] = ['Radio', 'Vadar', 'EvoRadio too loud? You can adjust the volume by typing \'/evoradio settings\' in the chat window. You can also turn the radio on and off while inside a vehicle by typing \'/evoradio (on/off]\' in the chat window.'];
...
$hints[] = ['Clans', 'Stell90', 'Want to make a clan? Type \'/clan create (Name]\' in the chat window.'];
$hints[] = ['Clans', 'Stell90', 'Want to join a clan? Type \'/clan accept (Presented Number]\' in the chat window if you\'ve been invited. To invite someone to your clan type \'/clan invite (ID]\' instead.'];
$hints[] = ['Clans', 'Stell90', 'Want to leave a clan? Type \'/clan leave\' in the chat window.'];
$hints[] = ['Clans', 'ForceGhost', 'Did you know we have a clan manager available on our website?'];
$hints[] = ['Clans', 'ForceGhost', 'You can request a custom clan model and logo prop if you fulfill the requirements listed on our forums!'];
$hints[] = ['Clans', 'Vadar', 'Make an advert on behalf of your clan by typing \'/cadvert (Message]\' in the chat window.'];


$hints[] = ['Money', 'Stell90', 'Typing \'/givemoney (Amount]\' in the chat window will give the specified amount to the person you\'re looking at.'];
$hints[] = ['Money', 'Stell90', 'Typing \'/dropmoney (Amount]\' will drop the specified amount on the floor in front of you.'];
$hints[] = ['Money', 'Stell90', 'Make sure you keep an eye on your account in the bottom left of the screen, money doesn\'t grow on trees you know!'];
...
$hints[] = ['Animation', 'Faustin', 'Did you know? We have a variety of new animations that you can perform by pressing \'F5\'.'];
$hints[] = ['Animation', 'Ben', 'Did you know? Our new animation menu is rebindable? Try typing \'bind (key] animationui\' in your console to set it to any key you\'d like. '];
...
$hints[] = ['Test', 'Internet', "This is a hint. uwu.\ndab\n\nTest with some \"quote marks\" today.\nThen we'll have some other single quotes."];
