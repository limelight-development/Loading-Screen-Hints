...
$hints[] = ['General', 'Taylor', 'Seen a man down and the ambulance is stuck in traffic? You can attempt to revive a downed player using \'CTRL + E\'.'];
...
$hints[] = ['Money', 'Taylor', 'Want to pay your staff a fair wage? Use \'/salary\'.'];
